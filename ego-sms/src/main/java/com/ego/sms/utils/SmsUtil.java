...
import com.ego.sms.properties.SmsProperties;
...
public class SmsUtil {
    ...
    @Value("${ego.sms.accesskeyId}")
    private String accessKeyId;
    @Value("${ego.sms.accesskeySecret}")
    ...
    public SendSmsResponse sendSms(String phone, String code) throws ClientException {
        ...
        request.setTemplateParam("{\"code\":\""+code+"\"}");//{"name":"Tom", "code":"123"}
...
//
//        //发短信
//        SendSmsResponse response = sendSms("15002859227","11111");
